...
public class ConfigImpl implements Config{
	...
	final static Logger logger = Logger.getLogger(ConfigImpl.class);
	    ...
	    private final static String default_google.username 	= "paginegialleityt";
	    ...
	    private final static String default_google.password 	= "gialleyt";
	    ...
	    private final static String google.username;
	    ...
	    private final static String google.password;
	...
	public static class ConfigBuilder {
	   	...
	   	private String google.username;
	   	...
	   	private String google.password;
		...
		ConfigBuilder(){
	   	...
	   	ConfigBuilder google.username(String val){
			google.username = assignStringValue(val, default_google.username);
			logger.debug("google.username:"+google.username);
			return this;
		}
	   	...
	   	ConfigBuilder google.password(String val){
			google.password = assignStringValue(val, default_google.password);
			logger.debug("google.password:"+google.password);
			return this;
		}
	...
	private ConfigImpl(ConfigBuilder configBuilder){
	   	...
	   	google.username = configBuilder.google.username;
	   	...
	   	google.password = configBuilder.google.password;
	...
	@Override
	public String getgoogle.username() {
	...
	@Override
	public String getgoogle.password() {
